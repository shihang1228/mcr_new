...
<form  class="checkbox addForm labelPadding">
	<ul class="list">
		...
		<li class="flex comInput"><div>联系电话:</div><div><input type="text" name="contactphone" id="contactphone"/></div></li>
...
<script type="text/javascript" src="js/companyadd.js?v=41c28fd"></script>

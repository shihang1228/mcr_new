...
<form class="onoff labelPadding" id="submitform">
	<ul class="list">
		...
		<li class="flex col1-3"><div>当前位置:</div><div><input type="text" name="dumpposition" id="dumpposition" value="<?php echo $dump["dumpposition"]; ?>"/></div></li>
	</ul>
		...
		<li class="flex">
			...
			<div class="op-3 hide">
				<select name="widerange" id="widerange">
				    ...
				    <option value="1" <?php echo $dump["widerange"]==0?"selected = 'selected'":"";?>>起步值</option>
				</select>
			</div>
		</li>
		<li class="flex">
	...
	<input type="hidden" name="cdkey" id="cdkey" <?php echo "value = \"".$cdkey."\""; ?>/>
</form>
<?php
}else{
...
<script type="text/javascript" src="mydumpupdate.js?v=41c28fd"></script>
<script>
collapse();
fliter();
</script>

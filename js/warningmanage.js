...
function start(flag){	
	...
	if($pagecount > $num){
		 $(".loading").show();
		 $.ajax({
			 url:'warningmanage_bgo.php',
			 type:'POST',
			data:"num="+$num+"&carnum="+carnum+"&kindselect="+jkindselect+"&startTime="+startTime+"&endTime="+endTime+"&stuffselect="+jstuffselect
						...
						for(var i=1;i<json.length;i++){
							...
							"<li>"+
								...
								"<a href='../detail.php?cdkey="+neirou.cdkey+"' class='li_link'>"+
									...
									"</p>"+
									"<p style='margin:5px 0 10px 10px;'>" + neirou.traindate + "</p>" +
								"</a>"+
								"<div class='tip'>"+

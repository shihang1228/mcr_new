(function () {
   ...
   function checkpic(){
	...
	function start(){
		...
		xhr.open('POST', 'companyadd_bgo.php',true);
		...
		var flag = false;
		if(ch1.checked){
		 keyword=keyword +"原木加工,";
		 flag = true;
		}
		if(ch2.checked){
		 keyword=keyword +"板材加工,";
		 flag = true;
		}
		if(ch3.checked){
		 keyword=keyword +"条子加工,";
		 flag = true;
		}
		if(ch4.checked){
		 keyword=keyword +"木材运输,";
		 flag = true;
		}
		if(ch5.checked){
		 keyword=keyword +"加工设备,";
		 flag = true;
		}
		if(ch6.checked){
		 keyword=keyword +"木材联运,";
		 flag = true;
		}

(function () {
   ...
   var data1;
    input.onchange = function () {
        ...
        lrz(this.files[0], {width: 480,height:360,qulatity:0.7}, function (results) {
	...
	var content=document.getElementById("content");//当前位置
	...
	content.onchange = function v_content(){
		if(content.value == 0){
			alert("请选择当前位置");
			content.focus();
			return false;
	...
	function start(){
             ...
             xhr.open('POST', '/system/control/receive.php',true);

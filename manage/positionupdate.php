...
<?php
	...
	$sqlstr = "select spotpositionid,position,d.ordervalue,salestatusname,code from t_spotposition d,t_salestatus s "
	  ." where d.salestatusid=s.salestatusid and d.spotpositionid =".$positionid;
...
<form  method="post" class="addForm" action="positionupdate_bgo.php">
	<dl class="panel boxShadowNone" >
		...
		<dd>
			<ul class="list">
			    <input type="hidden" name="positionid" value="<?php echo $position['spotpositionid'];?>" />

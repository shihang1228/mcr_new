<?php
	...
	/*select cdkey,kindid as kindname,stuffid as stuffname,phone,dumpposition,productlen,diameterlen
,wide,thinckness,widerange,thincknessrange,refcapacity,updatetime,timber as timbername,salestatusid as completestatus 
from v_product p,t_user u where p.userid=u.userid;*/
	
	 $query1 = "select cdkey,kindname,stuffname,phone,portname,dumpposition,"
	     ."l.lenname as productlen,"
		 ." diameterlen,wide,thinckness,dumpposition,widerange,thincknessrange,"
		 ...
		 ." sale.salestatusname as completestatus ";
		 
	  $query2= " from t_product p,t_kind k,t_stuff s,t_port r,t_user u,t_salestatus sale ,t_length l"
          ." where p.userid = u.userid and p.kindid = k.kindid and p.salestatusid=sale.salestatusid and "
		  ." p.stuffid = s.stuffid and p.portid =r.portid  and goodtype=2 and l.lenid = p.productlen ";	  

<?php
	...
	if($search !='0'){
	 ...
	 $query1 = "select keyword,c.cdkey as cdkey,right(rtrim(carnum),4) as carnum,"
	 ." ifnull((select stuffname from t_stuff where stuffid=p.stuffid),'') as stuffname,"
        ...
        ."ifnull((select kindname from t_kind where kindid=p.kindid),'') as kindname,c.updatetime " ;

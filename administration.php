...
<article class="user">
	...
	<ul class="list solidBottom iconList">
		<li><a href="manage/warningmanage.php"><i class="icon-database"></i>报警信息<i class="icon-angle-right"></i></a></li>
		<li><a href="manage/arrivalmanage.php"><i class="icon-database"></i>到货信息<i class="icon-angle-right"></i></a></li>
		<li><a href="index_new.php"><i class="icon-database"></i>首页<i class="icon-angle-right"></i></a></li>
	</ul>
</article>
<?php
}else{

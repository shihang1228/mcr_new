(function () {
   ...
   var data1;
	...
	function start(){
             ...
             xhr.open('POST', 'spotperfect_bgo.php',true);
...
//			 sendmessage.disabled=true;
			 ...
			 //  obj.portid =document.getElementById("portid").value;
			   ...
			   obj.partid=document.getElementById("partid").value;//取材位置
		   ...
		   if ((xhr.readyState == 4) && (xhr.status == 200)){
				...
				if(rec.result =="success"){
					...
					else
					{
						...
						var cdkey1 = document.getElementById("cdkey").value;
						var location1 = "detail.php?cdkey=" + cdkey1;

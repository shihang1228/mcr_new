		...
		<li class="flex col1-3"><div class="">关键字:</div>
			<ul class="border2">
				...
				<li class="flex checkbox">
					<input type="checkbox" name="keyword" id="ch1" /><label for="ch1">原木板材进口</label>
					<input type="checkbox" name="keyword" id="ch2" /><label for="ch2">防腐木扣板加工</label>
				</li>
				<li class="flex checkbox">
					<input type="checkbox" name="keyword" id="ch3" /><label for="ch3">拼板指接板</label>
					<input type="checkbox" name="keyword" id="ch4" /><label for="ch4">龙骨小料加工</label>
				</li>
				<li class="flex checkbox">
					<input type="checkbox" name="keyword" id="ch5" /><label for="ch5">干燥旋切</label>
					<input type="checkbox" name="keyword" id="ch6" /><label for="ch6">相关机械与化工</label>
				</li>
				<li class="flex checkbox">
					<input type="checkbox" name="keyword" id="ch7" /><label for="ch7">代理中介机构</label>
					<input type="checkbox" name="keyword" id="ch8" /><label for="ch8">其它</label>
				</li>
			</ul>
		</li>

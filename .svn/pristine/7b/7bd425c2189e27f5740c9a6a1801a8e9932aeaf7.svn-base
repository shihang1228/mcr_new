...
<style>
	.table.suc5>li:nth-child(1){width: 13%}
	.table.suc5>li:nth-child(2){width: 9%}
	.table.suc5>li:nth-child(3){width: 29%}
	.table.suc5>li:nth-child(4){width: 10%}
	.table.suc5>li:nth-child(5){width: 39%}

...
<ul class="list solidBottom iconList user">
	...
	<li><a href="">用户名<var class="user-item-info"><?php echo $user['username'];?></var><i class="icon-angle-right"></i></a></li>
	<li><a>手机号<var class="user-item-info"><?php echo $user['phone'];?></var><i class="icon-angle-right"></i></a></li>
	<li ><a href="javascript:void(0);">关注口岸<var class="user-item-info"><?php echo $user['portname'];?></var><i class="icon-angle-right"></i></a></li>

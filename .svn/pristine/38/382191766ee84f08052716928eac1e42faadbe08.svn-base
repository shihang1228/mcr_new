...
<form class="onoff labelPadding" id="submitform">
	<ul class="list">
		...
		<li class="flex">
			...
			<div>车皮号:</div><div><input type="tel" name ="carnum" id="carnum" value="<?php echo $dump["carnum"];?>"/></div>
			<div>树种:</div>
			<div>
		...
		<li class="flex">
		<div>总货量:</div><div><input type="tel" name="refcapacity" id="refcapacity" value="<?php echo $dump["refcapacity"]; ?>"/></div>
		<div>参考根数:</div><div><input type="tel" name="refnum" id="refnum" placeholder="100~20000" value="<?php echo $dump["refnum"];?>"/></div>
		</li>
		<li class="flex col1-3">
			<div>参考重量:</div><div><input type="tel" name="refwight" id="refwight" placeholder="40~90t" value="<?php echo $dump["refwight"];?>"/></div>
		</li>
		<li class="flex col1-3">
			<div>当前位置:</div>
			<?php
		...
		<li class="flex col1-3"><div>货主:</div><div><input type="text" name="contact" id="contact" value="<?php echo $dump["contact"];?> "/></div></li>
		<li class="flex col1-3"><div>手机号:</div><div><input type="tel" name="contactphone" id="contactphone" value="<?php echo $dump["contactphone"];?>" /></div></li>
	</ul>
	<ul class="list op-1 hide">
		<li class="flex">
			<div>径级(cm):</div><div><input type="tel" placeholder="10~80" name="diameterlen" id="diameterlen" value="<?php echo $dump["diameterlen"]; ?>"/></div>
			<div>材质:</div>
			<div>
	...
	<ul class="list op-2 hide">
		<li class="flex">
			<div>厚度(cm):</div><div><input type="tel" placeholder="10~500" name="thinckness" id="thinckness" value="<?php echo $dump["thinckness"];?>"/></div>
		...
		<li class="flex">
			<div>宽度(cm):</div><div><input type="tel" placeholder="10~500" name="wide" id="wide" value="<?php echo $dump["wide"];?>"/></div>
	...
	<ul class="list">
		...
		<li><textarea class="fullCol" rows="6" id="content" name="content" ><?php echo $dump["content"];?></textarea></li>
	</ul>
...
<script type="text/javascript" src="myspotupdate.js?v=41c28fd"></script>
<script>
collapse();
fliter();
</script>

<?php
	...
	*/
	 ...
	 $query1 = "select  buyid,portname,stuffname,kindname,wide,diameterlen,diameterlenMax,ifnull(timbername,0) as timber,thinckness,refcapacity,"
		  ...
		  ." case buystatus when 1 then '求购' else '已下架' end as buystatus,u.username as username ";

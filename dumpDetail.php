...
<?php
   if (!is_array($product_array)) {
	...
	$description = $row['dumpposition']." ".$row['content']."(点击查阅详细规格)";
	//addslashes($row['content']) str_replace(PHP_EOL, '', trim($row['content']))
...
<dl class="panel panel-theme">
	...
	<dd class="actionBtn">
		<div class="flex"><div><?php echo $row['updatetime'];?></div><div></div><div></div></div>
